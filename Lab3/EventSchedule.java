...
public class EventSchedule {
	...
	// public static int day = Calendar.getInstance().DATE; -- another way 
	//Calendar cal = Calendar.getInstance(); --- not recommended

	public EventSchedule() {
		// TO DO: write the proper constructor call and pass parameters here
		this(Calendar.getInstance().YEAR, (Calendar.getInstance().MONTH+1), Calendar.getInstance().DATE);
	...
	public EventSchedule(int year) {
		...
		this(year, (Calendar.getInstance().MONTH+1), Calendar.getInstance().DATE);
		//this.year = year;  // no need
	...
	public EventSchedule(int year, int month) {
		// complete code here
		this(year, month, Calendar.getInstance().DATE);
